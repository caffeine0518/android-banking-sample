...
/**
 * Mock 은행의 출금이체 처리 — 실제 KFTC 뒤에 있을 코어뱅킹에 해당한다.
 *
 ...
 */
internal class KftcWithdrawalService @Inject constructor(
     ...
     */
    fun withdraw(command: WithdrawCommand): WithdrawResult = transactionScope.inTransaction {
